...
import { SubtaskManager, EnhancedIssueLinking, ParentChildIndicator } from '../components/parent-child';
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              <Tooltip title="Manage Subtasks">
                <IconButton 
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    setSubtaskDialog({ open: true, issue: issue });
                  }}
                >
                  <SubTaskIcon sx={{ fontSize: 16 }} />
                </IconButton>
              </Tooltip>
              {/* Link Issues Button */}
              <Tooltip title="Link Issues">
                <IconButton 
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    setLinkingDialog({ open: true, issue: issue });
                  }}
                >
